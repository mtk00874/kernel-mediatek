...
//#endif
            ...
            //(void)mmc_suspend_host(host->mmc); /* 3.14 kernel do not have this internace */
            ...
            //host->mmc->pm_flags |= MMC_PM_IGNORE_PM_NOTIFY;  /* just for double confirm */  /* seems 3.14 do not have this interface */
...
#endif
            //(void)mmc_resume_host(host->mmc); /* 3.14 kernel do not have this internace */
        } else {
